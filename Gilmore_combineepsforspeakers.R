...
for(i in 1:21){
  season1[i] <- read_csv(paste("C:/Users/julie.wisch/Documents/GilmoreScripts/s01_",i,"_speakers.txt", sep=""))}
colnames(season1)[1]<-"text"

for(i in 1:22){
  season2[i] <- read_tsv(paste("C:/Users/julie.wisch/Documents/GilmoreScripts/s02_",i,"_speakers.txt", sep=""))}
